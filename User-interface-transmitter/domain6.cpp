...
void domain6::on_btnConfirm6_clicked()
{
    ...
    qDebug() << "Dialog::SendData[5] = " << Dialog::SendData[5];
    qDebug() << "Dialog::SendData[6] = " << Dialog::SendData[6];
    qDebug() << "Dialog::SendData[7] = " << Dialog::SendData[7];
