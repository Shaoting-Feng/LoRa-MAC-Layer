...
/* Mapping MSP pins to the design */
    ...
    /* SX1276 radio */
    #define PIN_SX1276_SPI_NSS              PIN_MSP_P1_3//PIN_MSP_P3_4
    #define PIN_SX1276_SPI_MOSI             PIN_MSP_P1_6//PIN_MSP_P3_6
    #define PIN_SX1276_SPI_MISO             PIN_MSP_P1_7//PIN_MSP_P3_7
    #define PIN_SX1276_SPI_SCLK             PIN_MSP_P2_2//PIN_MSP_P3_5
    #define PIN_SX1276_NRESET               PIN_MSP_P3_4//PIN_MSP_P7_1
    //#define PIN_SX1276_DIO0                   PIN_MSP_PJ_4
    #define PIN_SX1276_DIO0                 PIN_MSP_P4_3//PIN_MSP_P6_7


    /* tinySDR board LEDs */
    #define PIN_LED_D1                      PIN_MSP_P1_0
    #define PIN_LED_D2                      PIN_MSP_P4_6
...
//    #define PIN_SW_A1                       PIN_MSP_P7_0
    ...
    // FPGA
    #define PIN_FPGA_CLK                    PIN_MSP_P3_6
    #define PIN_FPGA_DATA                   PIN_MSP_P3_5

    //RF SWITCH
    #define PIN_SW_A                        PIN_MSP_P3_0
    #define PIN_SW_B                        PIN_MSP_P3_1
...
typedef enum
{
    ...
    // added by Shaoting
    MCU_STATE_BR_TX_INIT_2,
    MCU_STATE_BR_TX_WAIT_2,
    MCU_STATE_BR_TX_2
}MCU_States_t;
...
//#define MCP9808_SLAVE_ADDR  0x18 �¶ȴ�����
